...
$repo = "forge-gfx-palette-mark"
$language = "Dart"
$category = "Graphics"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/forge-gfx-palette-walkthrough.md")) {
