"""Regression checks for the forge-gfx-palette-mark casebook."""
...
from casebook.harness import assert_expected, forge_gfx_palette_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_gfx_palette_mark_summary(), assert_expected())
